...
exports.GradientaiKnowledgeBaseDataSource = void 0;
const pulumi = __importStar(require("@pulumi/pulumi"));
const utilities = __importStar(require("./utilities"));
class GradientaiKnowledgeBaseDataSource extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new GradientaiKnowledgeBaseDataSource(name, state, { ...opts, id: id });
    }
    /** @internal */
    static __pulumiType = 'digitalocean:index/gradientaiKnowledgeBaseDataSource:GradientaiKnowledgeBaseDataSource';
    /**
...
exports.GradientaiKnowledgeBaseDataSource = GradientaiKnowledgeBaseDataSource;
//# sourceMappingURL=gradientaiKnowledgeBaseDataSource.js.map