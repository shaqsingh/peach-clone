 ...
 */
export declare type ErrorHookFunction = (args: ErrorHookArgs) => boolean | Promise<boolean>;
/**
 * ErrorHook is a named hook that can be registered as an error hook.
 */
export declare class ErrorHook {
    /**
    ...
    static isInstance(obj: any): obj is ErrorHook;
}
/**
