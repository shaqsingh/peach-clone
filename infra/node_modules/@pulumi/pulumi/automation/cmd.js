...
class PulumiCommand {
    ...
    static async installWindows(opts) {
        const body = await download_1.download("https://get.pulumi.com/install.ps1");
    ...
    static async installPosix(opts) {
        const body = await download_1.download("https://get.pulumi.com/install.sh");
...
async function writeTempFile(contents, options) {
