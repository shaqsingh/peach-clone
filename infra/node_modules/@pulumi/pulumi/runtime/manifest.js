 ...
 * @internal
 */
exports.PACKAGE_MANIFEST_NAMES = ["package.json", "package.yaml"];
/**
...
function readPackageManifest(dir) {
    for (const name of exports.PACKAGE_MANIFEST_NAMES) {
 ...
 * @internal
 */
function searchupPackageManifest(startDir) {
    let dir = startDir;
    while (true) {
        for (const name of exports.PACKAGE_MANIFEST_NAMES) {
            const p = path.join(dir, name);
...
exports.searchupPackageManifest = searchupPackageManifest;
function parseManifestContent(name, content) {
