...
async function createClosureInfoAsync(func, serialize, logResource) {
    ...
    async function addEntriesForWellKnownGlobalObjectsAsync() {
        ...
        async function addGeneratorEntriesAsync() {
            ...
            await addEntriesAsync(Object.getPrototypeOf(emptyAsyncGenerator), "Object.getPrototypeOf(async function*(){})");
            await addEntriesAsync(Object.getPrototypeOf(emptyAsyncGenerator.prototype), "Object.getPrototypeOf((async function*(){}).prototype)");
        }
    }
}
 ...
 */
function isImportStarResult(obj) {
